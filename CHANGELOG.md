...
* Добавлены новые метрики и дополнительные параметры
* Добавлено новое лицензионное соглашение для комисси и обновлена ссылка на пользовательское соглашение
* Удалены неиспользуемые *.entitlements файлы
* Добавлена поддержка конкретного языка независимого от системных настроек
...
* Убраны экперементальные флаги компиляции
* Обновлена версия сберпей
* Исправлена утечка памяти
* Обновлена логика для получения версии библиотеки


## [7.4.0] (28-03-2025)

* Учтены требования НСПК для оплаты через СБП
* Обновлена документация и зависимости
* Уменьшена версия swift-tools-version до 5.6

## [7.3.0] (06-12-2024)

* Добавлена поддержка SPM
* Убран информер об автосписаниях из экрана настроек карты
...
* Обновление зависимостей. Обновление Readme.

## [6.15.0] (29-02-2024)

* Внесены исправления в работу платежного метода СБП
* Изменения логики отображения иконок банков/платежных систем для банковских карт

## [6.14.0] (02-11-2023)

* На половину уменьшен вес SDK. Исправлены минорные баги
...
* Добавили платежный метод — СБП

## [6.11.3] (26-05-2023)

* Исправили баг с бесконечным лоадером после завершения подтвержденя платежа
...
* Исправлен крэш, связанный с обработкой unknown кейсов в перечислениях.
* Обновлены версии бибилиотек.
* Исправлено несколько ui-багов.
...
## [6.6.2] (04-03-2022)
* изменения для работы с git.yoomoney.ru; фикс мелких багов
